package com.tpedro.server.grpc;
...
public final class MetricServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.tpedro.server.grpc.MetricRequest,
      com.tpedro.server.grpc.MetricResponse> getSendMetricMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendMetric",
      requestType = com.tpedro.server.grpc.MetricRequest.class,
      responseType = com.tpedro.server.grpc.MetricResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.tpedro.server.grpc.MetricRequest,
      com.tpedro.server.grpc.MetricResponse> getSendMetricMethod() {
    io.grpc.MethodDescriptor<com.tpedro.server.grpc.MetricRequest, com.tpedro.server.grpc.MetricResponse> getSendMetricMethod;
      ...
      synchronized (MetricServiceGrpc.class) {
        if ((getSendMetricMethod = MetricServiceGrpc.getSendMetricMethod) == null) {
          MetricServiceGrpc.getSendMetricMethod = getSendMetricMethod =
              io.grpc.MethodDescriptor.<com.tpedro.server.grpc.MetricRequest, com.tpedro.server.grpc.MetricResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sendMetric"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tpedro.server.grpc.MetricRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tpedro.server.grpc.MetricResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sendMetric(com.tpedro.server.grpc.MetricRequest request,
        io.grpc.stub.StreamObserver<com.tpedro.server.grpc.MetricResponse> responseObserver) {
  ...
  public static final class MetricServiceStub
    ...
    /**
     */
    public void sendMetric(com.tpedro.server.grpc.MetricRequest request,
        io.grpc.stub.StreamObserver<com.tpedro.server.grpc.MetricResponse> responseObserver) {
  ...
  public static final class MetricServiceBlockingStub
    ...
    /**
     */
    public com.tpedro.server.grpc.MetricResponse sendMetric(com.tpedro.server.grpc.MetricRequest request) {
  ...
  public static final class MetricServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.tpedro.server.grpc.MetricResponse> sendMetric(
        com.tpedro.server.grpc.MetricRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_METRIC:
          serviceImpl.sendMetric((com.tpedro.server.grpc.MetricRequest) request,
              (io.grpc.stub.StreamObserver<com.tpedro.server.grpc.MetricResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.tpedro.server.grpc.MetricRequest,
              com.tpedro.server.grpc.MetricResponse>(
  ...
  private static abstract class MetricServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.tpedro.server.grpc.MetricsProto.getDescriptor();
    }
